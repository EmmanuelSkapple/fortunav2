  ...
  render(){
    ...
    return(
      <div>
        ...
        {!this.state.modificar?
          <div className='CardItem' onClick={()=>this.setState({modificar:!this.state.modificar})}>
            <div className='imgCardItem'><img src={this.props.producto.imagenes?this.props.producto.imagenes[0]:''}></img></div>
            ...
            <div className='infoCardItem center'>
              <h3>Cantidad</h3>
              <p>{this.props.producto.cantidadProducto}</p>
            </div>
            <div className='infoCardItem center'>
              <h3>Creado el </h3>
              <p>{fechaCreacion}</p>
            </div>
            <div className='infoCardItem center btnModificar'>
              <p>Modificar</p>
            </div>
          </div>
          :
